...
// Using lat, longitude of the city for it's API
...
// To get city's Weather condition information
function displayTemp(response) {
  ...
  // To search for the city's weather condition
